...
public final class Icons {
    ...
    public static void gear(GuiGraphicsExtractor g, int x, int y, int s, int c) {
    ...
    public static void sliders(GuiGraphicsExtractor g, int x, int y, int s, int c) {
    ...
    public static void monitor(GuiGraphicsExtractor g, int x, int y, int s, int c) {
    ...
    public static void image(GuiGraphicsExtractor g, int x, int y, int s, int c) {
    ...
    public static void note(GuiGraphicsExtractor g, int x, int y, int s, int c) {
    ...
    public static void eye(GuiGraphicsExtractor g, int x, int y, int s, int c) {
        int mid = s / 2;
        for (int i = 0; i < s; i++) {
    ...
    public static void bolt(GuiGraphicsExtractor g, int x, int y, int s, int c) {
        int mid = s / 2;
        for (int i = 0; i < mid; i++) {
    ...
    public static void check(GuiGraphicsExtractor g, int x, int y, int s, int c) {
        int mid = s / 2;
        for (int i = 0; i < mid; i++) {
    ...
    public static void cross(GuiGraphicsExtractor g, int x, int y, int s, int c) {
        for (int i = 0; i < s; i++) {
    ...
    public static void chevron(GuiGraphicsExtractor g, int x, int y, int s, int c) {
        int mid = s / 2;
        for (int i = 0; i <= mid; i++) {
    ...
    public static void reset(GuiGraphicsExtractor g, int x, int y, int s, int c) {
    ...
    /** Info dot and stem. */
    public static void info(GuiGraphicsExtractor g, int x, int y, int s, int c) {
        int mid = s / 2;
