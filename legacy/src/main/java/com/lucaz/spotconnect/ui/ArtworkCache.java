...
public final class ArtworkCache {
    ...
    *///?} else {
    ...
    public static void draw(GuiGraphics g, String url, int x, int y, int size, String label) {
        ...
        //? if >=1.21.6 {
        /*g.blit(net.minecraft.client.renderer.RenderPipelines.GUI_TEXTURED, e.location(),
                x, y, 0f, 0f, size, size, e.width(), e.height(), e.width(), e.height());
        *///?} elif >=1.21.2 {
        /*g.blit(net.minecraft.client.renderer.RenderType::guiTextured, e.location(), x, y,
                0f, 0f, size, size, e.width(), e.height(), e.width(), e.height());
        *///?} else {
        ...
        try {
            ...
            *///?}
            ...
            /*Minecraft.getInstance().getTextureManager()
                    .register(loc, new DynamicTexture(loc::toString, image));
            *///?} else {
